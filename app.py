...
lineaccesstoken = 'joQjUxjSEjfdoX7VR2fc39Iz9HmNCC7VWOBSXUrJ5LZWfHx2Pn4tUwj/CznlTpIinRskU8STQEkVrJg2BwwUKZxa2qaTbX4P5I7tmvz7MeJp+CHmmRn2Iy3btwnQgr7WO40DTD4cc394HGqWLFZmyQdB04t89/1O/w1cDnyilFU='
...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if (msg == "สวัสดี"):
            replyObj = TextSendMessage(text="ดีค้าบ")
            line_bot_api.reply_message(rtoken, replyObj)
        elif  (msg == "กินข้าวมั้ย"):
            replyObj = TextSendMessage(text="ก็มาว่ะ")
            line_bot_api.reply_message(rtoken, replyObj)
        elif  (msg == "ไปเที่ยวมั้ย"):
            replyObj = TextSendMessage(text="เพื่อไรว่ะเอ๋อรึป่าวว่ะอย่าบ้า")
            line_bot_api.reply_message(rtoken, replyObj)
        elif  (msg == "เอ้าแค่ชวนทำไมต้องด่า"):
            replyObj = TextSendMessage(text="โทษทีพี่อินไปหน่อย")
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "covid" :
            ...
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/e4e08e85-074b-49a0-b35a-9fe46aaa8587"
